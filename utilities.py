...
def prepare_dirs_and_logger(config):
	...
	for path in [config.pre_model_dir, config.log_dir, config.model_dir, 
				os.path.join(config.model_dir,'saved_figures'),
				os.path.join(config.model_dir,'model1'),
				os.path.join(config.model_dir,'model2'),
				os.path.join(config.model_dir,'model3'),
				os.path.join(config.model_dir,'model4'),
				os.path.join(config.pre_model_dir,'brain3'),
				os.path.join(config.pre_model_dir,'brain4'),
				os.path.join(config.pre_model_dir,'brain5'),
				os.path.join(config.pre_model_dir,'brain6'),				
				os.path.join(config.pre_model_dir,'brain7'),				
				os.path.join(config.pre_model_dir,'brain8'),				
				os.path.join(config.pre_model_dir,'brain9'),				
				os.path.join(config.pre_model_dir,'brain10'),				
				os.path.join(config.log_dir,'reports')]:
...
def save_config(config):
	...
	save_json(config.__dict__,param_path)
